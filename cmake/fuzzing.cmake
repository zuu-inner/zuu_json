...
function(add_fuzz_target name)
    if(NOT ZUU_JSON_BUILD_FUZZERS)
        return()
    endif()

    if(NOT CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        message(FATAL_ERROR
            "ZUU_JSON_BUILD_FUZZERS requires Clang (libFuzzer is a Clang/"
            "compiler-rt feature). Reconfigure with "
            "-DCMAKE_CXX_COMPILER=clang++, or leave ZUU_JSON_BUILD_FUZZERS "
            "OFF to build the rest of the project with "
            "${CMAKE_CXX_COMPILER_ID}."
        )
    endif()

    set(target_name zuu_fuzz_${name})
    ...
    set_target_properties(${target_name} PROPERTIES OUTPUT_NAME "zuu_fuzz_${name}_run")

    target_link_libraries(${target_name} PRIVATE zuu_json::zuu_json)
    ...
    zuu_json_enable_warnings(${target_name})
