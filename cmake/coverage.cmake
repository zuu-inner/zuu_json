function(zuu_json_enable_coverage target_name)
    if(NOT ZUU_JSON_ENABLE_COVERAGE)
        return()
    endif()
...
if(ZUU_JSON_ENABLE_COVERAGE AND CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    if(LLVM_PROFDATA_EXE AND LLVM_COV_EXE)
        add_custom_target(coverage-report
            ...
            COMMAND ${LLVM_COV_EXE} report $<TARGET_FILE:zuu_json_api_test> -instr-profile=${CMAKE_BINARY_DIR}/code_coverage.profdata
        ...
        add_custom_target(coverage-html
            ...
            COMMAND ${LLVM_COV_EXE} show $<TARGET_FILE:zuu_json_api_test> -instr-profile=${CMAKE_BINARY_DIR}/code_coverage.profdata -format=html -output-dir=${CMAKE_BINARY_DIR}/out/coverage
            WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
