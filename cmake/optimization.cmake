...
function(zuu_json_enable_release_optimization target_name)
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang|GNU")
        ...
        if(ZUU_JSON_ENABLE_NATIVE_OPTIMIZATION)
            target_compile_options(${target_name} PRIVATE
    ...
    if(IPO_SUPPORTED AND ZUU_JSON_ENABLE_IPO AND NOT ZUU_JSON_BUILD_FUZZERS)
